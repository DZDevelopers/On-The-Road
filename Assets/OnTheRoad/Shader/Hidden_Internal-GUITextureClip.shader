...
void main ()
{
  ...
  if (_ManualTex2SRGB) {
    ...
    colTex_2.xyz = tmpvar_6;
  };
  lowp vec4 tmpvar_7;
  tmpvar_7 = (colTex_2 * xlv_COLOR);
  col_1.xyz = tmpvar_7.xyz;
  col_1.w = (tmpvar_7.w * texture2D (_GUIClipTexture, xlv_TEXCOORD1).w);
  gl_FragData[0] = col_1;
}
...
void main()
{
    ...
    u_xlat10_0.x = texture(_GUIClipTexture, vs_TEXCOORD1.xy).w;
