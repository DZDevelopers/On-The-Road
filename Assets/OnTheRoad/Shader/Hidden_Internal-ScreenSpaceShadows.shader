...
void main()
{
    ...
    u_xlat4.xy = vec2(u_xlat4.y * float(0.0408160016), u_xlat4.w * float(0.0408160016));
    ...
    u_xlat0.x = u_xlat7.w * u_xlat10_18 + u_xlat0.x;
    u_xlat5.y = u_xlat1.z;
    u_xlat7 = u_xlat2.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat5.xyzy;
    ...
    u_xlat10_18 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec6, 0.0);
    ...
    u_xlat10_18 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec10, 0.0);
    ...
    u_xlat10_2 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec12, 0.0);
    ...
    u_xlat0.x = u_xlat4.w * u_xlat10_2 + u_xlat0.x;
...
void main()
{
    ...
    u_xlat0.x = u_xlat7.x * u_xlat10_0 + u_xlat8.x;
...
void main()
{
    ...
    u_xlat6.z = u_xlat17.y * 0.0816320032;
    u_xlat17.xy = u_xlat4.xz * vec2(0.5, 0.5) + (-u_xlat0.xy);
    u_xlat3.zw = vec2(u_xlat4.w * float(0.0408160016), u_xlat4.y * float(0.0408160016));
    u_xlat6.xy = u_xlat17.yx * vec2(0.0816320032, 0.0816320032);
    u_xlat5.x = u_xlat6.y;
    u_xlat2.w = u_xlat3.z;
    u_xlat5.yw = u_xlat0.xx * vec2(-0.0816320032, 0.0816320032) + vec2(0.163264006, 0.0816320032);
