...
void main ()
{
  ...
  tmpvar_26 = mix (shadowAttenuation_20, 1.0, tmpvar_18);
...
void main ()
{
  ...
  tmpvar_34 = mix (shadowAttenuation_20, 1.0, tmpvar_18);
...
void main()
{
    ...
    u_xlat3.xy = vec2(u_xlat5.y / u_xlat6.z, u_xlat5.w / u_xlat6.w);
    ...
    u_xlat3.xy = vec2(u_xlat4.y / u_xlat7.y, u_xlat4.w / u_xlat7.w);
    ...
    u_xlat10_20 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec1, 0.0);
    u_xlat20 = u_xlat10_20 * u_xlat4.y;
    u_xlat10.x = u_xlat4.x * u_xlat10_10 + u_xlat20;
    vec3 txVec2 = vec3(u_xlat5.xy,u_xlat3.z);
    u_xlat10_20 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec2, 0.0);
    vec3 txVec3 = vec3(u_xlat5.zw,u_xlat3.z);
    u_xlat10_3 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec3, 0.0);
    u_xlat10.x = u_xlat4.z * u_xlat10_20 + u_xlat10.x;
    u_xlat10.x = u_xlat4.w * u_xlat10_3 + u_xlat10.x;
    ...
    u_xlat16_38 = u_xlat10_1.w * 128.0;
...
void main ()
{
  ...
  mediump float tmpvar_18;
  tmpvar_18 = mix (shadowAttenuation_16, 1.0, tmpvar_14);
  atten_6 = tmpvar_18;
  lowp vec4 tmpvar_19;
  highp vec2 P_20;
...
void main ()
{
  ...
  tmpvar_24 = mix (tmpvar_23, 1.0, tmpvar_16);
  atten_6 = (tmpvar_15.x * tmpvar_24);
  lowp vec4 tmpvar_25;
  highp vec2 P_26;
...
void main()
{
    ...
    u_xlat10_12 = texture(hlslcc_zcmp_ShadowMapTexture, txVec0);
    u_xlat16_4.x = (-_LightShadowData.x) + 1.0;
    u_xlat16_4.x = u_xlat10_12 * u_xlat16_4.x + _LightShadowData.x;
...
void main ()
{
  ...
  mediump float tmpvar_39;
  tmpvar_39 = mix (dot (tmpvar_38, vec4(0.25, 0.25, 0.25, 0.25)), 1.0, tmpvar_16);
  atten_6 = (tmpvar_15.x * tmpvar_39);
  lowp vec4 tmpvar_40;
  highp vec2 P_41;
...
void main()
{
    ...
    u_xlat10_14 = texture(hlslcc_zcmp_ShadowMapTexture, txVec0);
    u_xlat16_4.x = (-_LightShadowData.x) + 1.0;
    u_xlat16_4.x = u_xlat10_14 * u_xlat16_4.x + _LightShadowData.x;
    ...
    u_xlat16_4.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat16_25 = u_xlat10_1.w * 128.0;
